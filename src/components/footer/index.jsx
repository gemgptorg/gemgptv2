            ...
            <div className="footer-main">
                ...
                <div className="container">
                    <ul className="widget-social">
                        <li>
                            <a href="https://twitter.com/gemgptlabs" target="_blank">
                        ...
                        <li>
                            <a href="https://t.me/gemgpt" target="_blank">
                        ...
                        <li>
                            <a href="https://www.youtube.com/@GemGPT" target="_blank">
                        ...
                        <li>
                            <a href="https://www.tiktok.com/@gemgpt?is_from_webapp=1&sender_device=pc" target="_blank">
